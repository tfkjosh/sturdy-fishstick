...
//we always need to respond with a 200 status code to shopify, otherwise it will continue to retry the request
  ...
  if (!isCollectionUpdate && !isProductUpdate) {
    //we dont need to revalidate anything for any other topics.
    return NextResponse.json({ status: 200 });
  }
